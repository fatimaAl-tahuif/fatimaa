...
/*
ينفذ الكود قائمة مرتبطة ثنائية الاتجاه في لغة جافا.
تتضمن وظائف أساسية مثل إضافة وإزالة العناصر من بداية ونهاية القائمة.
يستخدم الكود عقدتين وهميتين لتبسيط بعض العمليات.
يمكن تحسين بعض الطرق لزيادة الكفاءة.
يمكن إضافة تعليقات توضيحية باللغة العربية لزيادة قابلية القراءة والفهم.
 */