...
/*
يهدف هذا الكود إلى نسخ قائمة مرتبطة ثنائية الاتجاه (doubly linked list) إلى قائمة دائرية (circularly linked list).

نسخ قائمة مرتبطة ثنائية الاتجاه إلى قائمة دائرية.
 */